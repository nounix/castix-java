    ...
    function Signaler(root, roomid) {
        ...
        var options = {
            ...
            onaddstream: function(stream, _userid) {
                ...
                video.autoplay = true;
                video.controls = true;
                video.width = $(document).width() * 0.90;
                video.play();
        ...
        /*To use own Firebase Acc:
        1. Create a Google Acc & go to Firebase
        2. Create new Project & go to Database
        ...
        */
        // 4. Uncomment line below and change the ID
        root.firebase = 'rpi-testi-b8b50';
            ...
            socket.on('child_added', function(snap) {
                ...
                if (isRemoteMessage) {
                    ...
                    if (!data.leaving) signaler.onmessage(data);
                        ...
                        if (root.onuserleft) root.onuserleft(data.userid);
                    }
                }
            ...
            socket = root.openSignalingChannel(function(message) {
                ...
                if (isRemoteMessage) {
                    ...
                    if (!message.leaving) signaler.onmessage(message);
                        ...
                        if (root.onuserleft) root.onuserleft(message.userid);
                        numberOfParticipants--;
                        if (root.onNumberOfParticipantsChnaged) root.onNumberOfParticipantsChnaged(numberOfParticipants);
                    }
                }
...
(function() {
    $.ajax({
        type : "GET",
        url : window.location + "/get-channel",
        success: function(result){
            window.screen = new Screen(result);
            window.screen.onaddstream = function(e) {
